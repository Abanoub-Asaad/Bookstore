    ...
    return (
        <View style={{ backgroundColor: 'white' }}>
          ...
          <View style={styles.cardImgWrapper}>
            <Image
              source={require('../screen/Images/funny.jpg')}
              resizeMode="stretch"
        ...
        <View style={styles.card}>
          <View style={styles.cardImgWrapper}>
            <Image
              source={require('../screen/Images/drama.jpg')}
              resizeMode="stretch"
              style={styles.cardImg}
            />
          </View>
        ...
        <View style={styles.card}>
          <View style={styles.cardImgWrapper}>
            <Image
              source={require('../screen/Images/romantic.jpg')}
              resizeMode="stretch"
              style={styles.cardImg}
            />
          </View>
        ...
        <View style={styles.card}>
          <View style={styles.cardImgWrapper}>
            <Image
              source={require('../screen/Images/horror.jpg')}
              resizeMode="stretch"
              style={styles.cardImg}
            />
          </View>
        ...
        <View style={styles.card}>
          <View style={styles.cardImgWrapper}>
            <Image
              source={require('../screen/Images/action.jpg')}
              resizeMode="stretch"
              style={styles.cardImg}
            />
          </View>
